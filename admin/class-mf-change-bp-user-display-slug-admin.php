...
class Mf_Change_Bp_User_Display_Slug_Admin {
	...
	public function add_options_page() {
		...
		$this->plugin_screen_hook_suffix = add_users_page(
			__( 'WP Change BuddyPress User Display Name and Slug Settings', 'mf-change-bp-user-display-slug' ),
			__( 'WP Change BuddyPress User Display Name and Slug', 'mf-change-bp-user-display-slug' ),
			'manage_options',
			$this->plugin_name,
