...
<h2>Change BuddyPress User Display Name and Slug - Settings</h2>
...
$user_nicename_exists = $wpdb->get_results("SELECT ID FROM wp_users WHERE user_nicename = '$new_user_nicename'");	
